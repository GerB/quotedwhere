...
$lang = array_merge($lang, array(
    ...
    'QW_REPARSE_EXPLAIN'                => 'Het lijkt erop dat je forum geconverteerd is van een eerdere versie dan phpBB 3.2. phpBB 3.2 maakt gebruik van een nieuwe manier om berichten op te slaan. Deze conversie vind in stappen plaats en je moet er zeker van zijn dat al je berichten opnieuw geparsed zijn. <a target="_blank" href="https://www.phpbb.com/community/viewtopic.php?f=461&t=2473851#p15031151">Lees meer</a>.<br><br>Er zijn ongeveer <strong>%d</strong> berichten op je forum die nog geconverteerd moeten worden om op de juiste manier geïndexeerd te kunnen worden. Het is beter om eerst te reparsen en daarna een goede index op te bouwen.',
